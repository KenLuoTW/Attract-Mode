::sg_directory <- FeConfigDirectory + "themes/HeyChromey/scripts/shadow-glow/";
::sg_dir <- sg_directory;
...
class AmbiGlow {
    ...
    constructor (_pA, _sr = 200, _sx = 0, _sy = 0, _sa = 255, _ds = 0.5, _surface = null) {
        try {
            _picA = _pA;
        }
        catch (e) {
        ...
        _surfB = _surface.add_surface( _surfA.width, _surfA.height );
...
class DropShadow extends AmbiGlow {
    ...
    function set_ds_visible (boolvalue) {
        _surfB.visible = boolvalue;
    }
